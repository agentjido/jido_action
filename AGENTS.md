...
### Zoi vs NimbleOptions Schemas

**For NEW actions, prefer Zoi schemas** for better validation and transformations:
...
# NimbleOptions (still supported, legacy)
use Jido.Action,
  schema: [
...
- Maintaining existing actions
- Simple schemas without transformations
