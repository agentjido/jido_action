...
An Instruction uses the rules of its resolved target. All Instructions accept
`timeout:`, `jido:`, `max_concurrency:`, and `max_continuations:`. An
Instruction can be a target for `Jido.Exec.run_async/4`.
